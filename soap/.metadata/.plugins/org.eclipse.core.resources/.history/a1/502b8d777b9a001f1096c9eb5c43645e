...
public class PERType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.PERInfoType[] PERInfo;
    ...
    public PERType(
           ...
           xsd.MNPProtocol.PERInfoType[] PERInfo,
    ...
    /**
     * Gets the messageSenderTelco value for this PERType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this PERType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this PERType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this PERType.
     * 
    ...
    /**
     * Gets the requestId value for this PERType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this PERType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this PERType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this PERType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the PERInfo value for this PERType.
     * 
     * @return PERInfo
     */
    public xsd.MNPProtocol.PERInfoType[] getPERInfo() {
        return PERInfo;
    }


    /**
     * Sets the PERInfo value for this PERType.
     * 
     * @param PERInfo
     */
    public void setPERInfo(xsd.MNPProtocol.PERInfoType[] PERInfo) {
        this.PERInfo = PERInfo;
    }

    public xsd.MNPProtocol.PERInfoType getPERInfo(int i) {
        return this.PERInfo[i];
    }

    public void setPERInfo(int i, xsd.MNPProtocol.PERInfoType _value) {
        this.PERInfo[i] = _value;
    }


    /**
     * Gets the version value for this PERType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this PERType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof PERType)) return false;
        PERType other = (PERType) obj;
        ...
        _equals = true && 
            ...
            ((this.PERInfo==null && other.getPERInfo()==null) || 
             (this.PERInfo!=null &&
              java.util.Arrays.equals(this.PERInfo, other.getPERInfo()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getPERInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getPERInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getPERInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(PERType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "PERType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("PERInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "PERInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "PERInfoType"));
        elemField.setNillable(false);
