...
public class RNAType  implements java.io.Serializable {
    ...
    private java.lang.String suspectedTelco;
    ...
    public RNAType(
           ...
           java.lang.String suspectedTelco,
           ...
           this.suspectedTelco = suspectedTelco;
           this.version = version;
    }


    /**
     * Gets the messageSenderTelco value for this RNAType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this RNAType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this RNAType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this RNAType.
     * 
    ...
    /**
     * Gets the requestId value for this RNAType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this RNAType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this RNAType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this RNAType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the referenceId value for this RNAType.
     * 
     * @return referenceId
     */
    ...
    /**
     * Sets the referenceId value for this RNAType.
     * 
     * @param referenceId
     */
    ...
    /**
     * Gets the subscriberNumber value for this RNAType.
     * 
    ...
    /**
     * Sets the subscriberNumber value for this RNAType.
     * 
    ...
    /**
     * Gets the routeNumber value for this RNAType.
     * 
     * @return routeNumber
     */
    ...
    /**
     * Sets the routeNumber value for this RNAType.
     * 
     * @param routeNumber
     */
    ...
    /**
     * Gets the suspectedTelco value for this RNAType.
     * 
     * @return suspectedTelco
     */
    public java.lang.String getSuspectedTelco() {
        return suspectedTelco;
    }


    /**
     * Sets the suspectedTelco value for this RNAType.
     * 
     * @param suspectedTelco
     */
    public void setSuspectedTelco(java.lang.String suspectedTelco) {
        this.suspectedTelco = suspectedTelco;
    }


    /**
     * Gets the version value for this RNAType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this RNAType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RNAType)) return false;
        RNAType other = (RNAType) obj;
        ...
        _equals = true && 
            ...
            ((this.suspectedTelco==null && other.getSuspectedTelco()==null) || 
             (this.suspectedTelco!=null &&
              this.suspectedTelco.equals(other.getSuspectedTelco()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSuspectedTelco() != null) {
            _hashCode += getSuspectedTelco().hashCode();
        }
        if (getVersion() != null) {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RNAType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "RNAType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("suspectedTelco");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "SuspectedTelco"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", ">SuspectedTelco"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
