...
public class CANType  implements java.io.Serializable {
    ...
    /**
     * Gets the subscriberNumber value for this CANType.
     * 
    ...
    /**
     * Sets the subscriberNumber value for this CANType.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "CANType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "ReasonCode"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", ">ReasonCode"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("reasonText");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "ReasonText"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", ">ReasonText"));
