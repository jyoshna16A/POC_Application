...
public class SDType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.SDInfoType[] SDInfo;
    ...
    public SDType(
           ...
           xsd.MNPProtocol.SDInfoType[] SDInfo,
     ...
     * @return SDInfo
     */
    public xsd.MNPProtocol.SDInfoType[] getSDInfo() {
        return SDInfo;
    }
     ...
     * @param SDInfo
     */
    public void setSDInfo(xsd.MNPProtocol.SDInfoType[] SDInfo) {
        this.SDInfo = SDInfo;
    }

    public xsd.MNPProtocol.SDInfoType getSDInfo(int i) {
        return this.SDInfo[i];
    }

    public void setSDInfo(int i, xsd.MNPProtocol.SDInfoType _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SDType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "SDInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SDInfoType"));
        elemField.setNillable(false);
