...
public class RDBPDType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.NumberRangeType numberRange;

    private xsd.MNPProtocol.TimeRangeType timeRange;
    ...
    public RDBPDType(
           ...
           xsd.MNPProtocol.NumberRangeType numberRange,
           xsd.MNPProtocol.TimeRangeType timeRange,
    ...
    /**
     * Gets the messageSenderTelco value for this RDBPDType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this RDBPDType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this RDBPDType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this RDBPDType.
     * 
    ...
    /**
     * Gets the requestId value for this RDBPDType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this RDBPDType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this RDBPDType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this RDBPDType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the subscriberSequence value for this RDBPDType.
     * 
    ...
    /**
     * Sets the subscriberSequence value for this RDBPDType.
     * 
    ...
    /**
     * Gets the numberRange value for this RDBPDType.
     * 
     * @return numberRange
     */
    public xsd.MNPProtocol.NumberRangeType getNumberRange() {
        return numberRange;
    }


    /**
     * Sets the numberRange value for this RDBPDType.
     * 
     * @param numberRange
     */
    public void setNumberRange(xsd.MNPProtocol.NumberRangeType numberRange) {
        this.numberRange = numberRange;
    }


    /**
     * Gets the timeRange value for this RDBPDType.
     * 
     * @return timeRange
     */
    public xsd.MNPProtocol.TimeRangeType getTimeRange() {
        return timeRange;
    }


    /**
     * Sets the timeRange value for this RDBPDType.
     * 
     * @param timeRange
     */
    public void setTimeRange(xsd.MNPProtocol.TimeRangeType timeRange) {
        this.timeRange = timeRange;
    }


    /**
     * Gets the LSA value for this RDBPDType.
     * 
     * @return LSA
     */
    ...
    /**
     * Sets the LSA value for this RDBPDType.
     * 
     * @param LSA
     */
    ...
    /**
     * Gets the version value for this RDBPDType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this RDBPDType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RDBPDType)) return false;
        RDBPDType other = (RDBPDType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RDBPDType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "RDBPDType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "NumberRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "NumberRangeType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("timeRange");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "TimeRange"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "TimeRangeType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
