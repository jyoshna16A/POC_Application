...
public class SCInfoType  implements java.io.Serializable {
    ...
    /**
     * Gets the subscriberNumber value for this SCInfoType.
     * 
    ...
    /**
     * Sets the subscriberNumber value for this SCInfoType.
     * 
    ...
    /**
     * Gets the referenceId value for this SCInfoType.
     * 
     * @return referenceId
     */
    ...
    /**
     * Sets the referenceId value for this SCInfoType.
     * 
     * @param referenceId
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SCInfoType)) return false;
        SCInfoType other = (SCInfoType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SCInfoType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SCInfoType"));
