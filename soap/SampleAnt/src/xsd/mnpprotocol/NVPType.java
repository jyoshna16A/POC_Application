 ...
 *         &lt;element ref="{MNPProtocol.xsd}TimeoutDate"/&gt;
...
@XmlType(name = "NVPType", propOrder = {
    "messageSenderTelco",
...
public class NVPType {
    ...
    @XmlElement(name = "TimeoutDate", required = true)
    @XmlSchemaType(name = "dateTime")
     ...
     *     
     */
    public void setTimeoutDate(XMLGregorianCalendar value) {
