...
/**
 * <p>Java class for SDType complex type.
 * 
 ...
 *         &lt;element name="SDInfo" type="{MNPProtocol.xsd}SDInfoType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class SDType {
    ...
    @XmlElement(name = "SDInfo", required = true)
    protected List<SDInfoType> sdInfo;
    ...
    /**
     * Gets the value of the sdInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the sdInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSDInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SDInfoType> getSDInfo() {
        if (sdInfo == null) {
            sdInfo = new ArrayList<SDInfoType>();
        }
        return this.sdInfo;
    }
