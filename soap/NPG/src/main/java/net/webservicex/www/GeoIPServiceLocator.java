...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements net.webservicex.www.GeoIPService {
    ...
    private java.lang.String GeoIPServiceSoap12_address = "http://www.webservicex.net/geoipservice.asmx";
    ...
    public net.webservicex.www.GeoIPServiceSoap getGeoIPServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public net.webservicex.www.GeoIPServiceSoap getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.webservicex.www.GeoIPServiceSoap12Stub _stub = new net.webservicex.www.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            ...
            if (net.webservicex.www.GeoIPServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                net.webservicex.www.GeoIPServiceSoap12Stub _stub = new net.webservicex.www.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.webservicex.net/", "GeoIPServiceSoap12"));
        }
