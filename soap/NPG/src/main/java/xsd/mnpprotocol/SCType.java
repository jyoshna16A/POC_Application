...
/**
 * <p>Java class for SCType complex type.
 * 
 ...
 *         &lt;element name="SCInfo" type="{MNPProtocol.xsd}SCInfoType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class SCType {
    ...
    @XmlElement(name = "SCInfo", required = true)
    protected List<SCInfoType> scInfo;
    ...
    /**
     * Gets the value of the scInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the scInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSCInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<SCInfoType> getSCInfo() {
        if (scInfo == null) {
            scInfo = new ArrayList<SCInfoType>();
        }
        return this.scInfo;
    }
