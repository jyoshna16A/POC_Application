...
/**
 * <p>Java class for NPOSQRspType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NPOSQRspType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="StatusResult" type="{MNPProtocol.xsd}StatusResultType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "NPOSQRspType", propOrder = {
    "messageSenderTelco",
...
public class NPOSQRspType {
    ...
    @XmlElement(name = "StatusResult", required = true)
    protected List<StatusResultType> statusResult;
     ...
     * {@link StatusResultType }
     * 
     * 
     */
    public List<StatusResultType> getStatusResult() {
        if (statusResult == null) {
            statusResult = new ArrayList<StatusResultType>();
        }
