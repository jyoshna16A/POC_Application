 ...
 *         &lt;element name="PERInfo" type="{MNPProtocol.xsd}PERInfoType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
public class PERType {
    ...
    @XmlElement(name = "PERInfo", required = true)
    protected List<PERInfoType> perInfo;
    ...
    /**
     * Gets the value of the perInfo property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the perInfo property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPERInfo().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PERInfoType> getPERInfo() {
        if (perInfo == null) {
            perInfo = new ArrayList<PERInfoType>();
        }
        return this.perInfo;
    }
