...
public class NPOSQType  implements java.io.Serializable {
    ...
    public NPOSQType(
           ...
           java.lang.String[] batchReference,
    ...
    /**
     * Gets the messageSenderTelco value for this NPOSQType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this NPOSQType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this NPOSQType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this NPOSQType.
     * 
    ...
    /**
     * Gets the requestId value for this NPOSQType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this NPOSQType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this NPOSQType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this NPOSQType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the batchReference value for this NPOSQType.
     * 
    ...
    /**
     * Sets the batchReference value for this NPOSQType.
     * 
    ...
    /**
     * Gets the version value for this NPOSQType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this NPOSQType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NPOSQType)) return false;
        NPOSQType other = (NPOSQType) obj;
        ...
        _equals = true && 
            ...
            ((this.batchReference==null && other.getBatchReference()==null) || 
             (this.batchReference!=null &&
              java.util.Arrays.equals(this.batchReference, other.getBatchReference()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getBatchReference() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBatchReference());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBatchReference(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NPOSQType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "NPOSQType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("batchReference");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "BatchReference"));
