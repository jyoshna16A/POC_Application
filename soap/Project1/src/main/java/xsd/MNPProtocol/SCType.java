...
public class SCType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.SCInfoType[] SCInfo;
    ...
    public SCType(
           ...
           xsd.MNPProtocol.SCInfoType[] SCInfo,
    ...
    /**
     * Gets the messageSenderTelco value for this SCType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this SCType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this SCType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this SCType.
     * 
    ...
    /**
     * Gets the requestId value for this SCType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this SCType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this SCType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this SCType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the SCInfo value for this SCType.
     * 
     * @return SCInfo
     */
    public xsd.MNPProtocol.SCInfoType[] getSCInfo() {
        return SCInfo;
    }


    /**
     * Sets the SCInfo value for this SCType.
     * 
     * @param SCInfo
     */
    public void setSCInfo(xsd.MNPProtocol.SCInfoType[] SCInfo) {
        this.SCInfo = SCInfo;
    }

    public xsd.MNPProtocol.SCInfoType getSCInfo(int i) {
        return this.SCInfo[i];
    }

    public void setSCInfo(int i, xsd.MNPProtocol.SCInfoType _value) {
        this.SCInfo[i] = _value;
    }


    /**
     * Gets the version value for this SCType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this SCType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SCType)) return false;
        SCType other = (SCType) obj;
        ...
        _equals = true && 
            ...
            ((this.SCInfo==null && other.getSCInfo()==null) || 
             (this.SCInfo!=null &&
              java.util.Arrays.equals(this.SCInfo, other.getSCInfo()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSCInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSCInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSCInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SCType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SCType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("SCInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "SCInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SCInfoType"));
        elemField.setNillable(false);
