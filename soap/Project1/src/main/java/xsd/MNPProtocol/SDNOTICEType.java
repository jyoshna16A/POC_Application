...
public class SDNOTICEType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.BCInfoType[] BCInfo;
    ...
    public SDNOTICEType(
           ...
           xsd.MNPProtocol.BCInfoType[] BCInfo,
           java.lang.String batchId,
           java.lang.String LSA,
           java.math.BigInteger checksum,
    ...
    /**
     * Gets the messageSenderTelco value for this SDNOTICEType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this SDNOTICEType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this SDNOTICEType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this SDNOTICEType.
     * 
    ...
    /**
     * Gets the requestId value for this SDNOTICEType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this SDNOTICEType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this SDNOTICEType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this SDNOTICEType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the BCInfo value for this SDNOTICEType.
     * 
     * @return BCInfo
     */
    public xsd.MNPProtocol.BCInfoType[] getBCInfo() {
        return BCInfo;
    }


    /**
     * Sets the BCInfo value for this SDNOTICEType.
     * 
     * @param BCInfo
     */
    public void setBCInfo(xsd.MNPProtocol.BCInfoType[] BCInfo) {
        this.BCInfo = BCInfo;
    }

    public xsd.MNPProtocol.BCInfoType getBCInfo(int i) {
        return this.BCInfo[i];
    }

    public void setBCInfo(int i, xsd.MNPProtocol.BCInfoType _value) {
        this.BCInfo[i] = _value;
    }


    /**
     * Gets the batchId value for this SDNOTICEType.
     * 
     * @return batchId
     */
    ...
    /**
     * Sets the batchId value for this SDNOTICEType.
     * 
     * @param batchId
     */
    ...
    /**
     * Gets the LSA value for this SDNOTICEType.
     * 
     * @return LSA
     */
    ...
    /**
     * Sets the LSA value for this SDNOTICEType.
     * 
     * @param LSA
     */
    ...
    /**
     * Gets the checksum value for this SDNOTICEType.
     * 
     * @return checksum
     */
    ...
    /**
     * Sets the checksum value for this SDNOTICEType.
     * 
     * @param checksum
     */
    ...
    /**
     * Gets the version value for this SDNOTICEType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this SDNOTICEType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SDNOTICEType)) return false;
        SDNOTICEType other = (SDNOTICEType) obj;
        ...
        _equals = true && 
            ...
            ((this.BCInfo==null && other.getBCInfo()==null) || 
             (this.BCInfo!=null &&
              java.util.Arrays.equals(this.BCInfo, other.getBCInfo()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getBCInfo() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getBCInfo());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getBCInfo(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SDNOTICEType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "SD-NOTICEType"));
        ...
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("BCInfo");
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "BCInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "BCInfoType"));
        elemField.setNillable(false);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "Checksum"));
