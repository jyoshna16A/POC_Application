...
public class NPOSQRspType  implements java.io.Serializable {
    ...
    private xsd.MNPProtocol.StatusResultType[] statusResult;
    ...
    public NPOSQRspType(
           ...
           xsd.MNPProtocol.StatusResultType[] statusResult,
    ...
    /**
     * Gets the messageSenderTelco value for this NPOSQRspType.
     * 
    ...
    /**
     * Sets the messageSenderTelco value for this NPOSQRspType.
     * 
    ...
    /**
     * Gets the messageReceiverTelco value for this NPOSQRspType.
     * 
    ...
    /**
     * Sets the messageReceiverTelco value for this NPOSQRspType.
     * 
    ...
    /**
     * Gets the requestId value for this NPOSQRspType.
     * 
     * @return requestId
     */
    ...
    /**
     * Sets the requestId value for this NPOSQRspType.
     * 
     * @param requestId
     */
    ...
    /**
     * Gets the timestamp value for this NPOSQRspType.
     * 
     * @return timestamp
     */
    ...
    /**
     * Sets the timestamp value for this NPOSQRspType.
     * 
     * @param timestamp
     */
    ...
    /**
     * Gets the statusResult value for this NPOSQRspType.
     * 
     * @return statusResult
     */
    public xsd.MNPProtocol.StatusResultType[] getStatusResult() {
        return statusResult;
    }


    /**
     * Sets the statusResult value for this NPOSQRspType.
     * 
     * @param statusResult
     */
    public void setStatusResult(xsd.MNPProtocol.StatusResultType[] statusResult) {
        this.statusResult = statusResult;
    }

    public xsd.MNPProtocol.StatusResultType getStatusResult(int i) {
        return this.statusResult[i];
    }

    public void setStatusResult(int i, xsd.MNPProtocol.StatusResultType _value) {
        this.statusResult[i] = _value;
    }


    /**
     * Gets the version value for this NPOSQRspType.
     * 
     * @return version
     */
    ...
    /**
     * Sets the version value for this NPOSQRspType.
     * 
     * @param version
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NPOSQRspType)) return false;
        NPOSQRspType other = (NPOSQRspType) obj;
        ...
        _equals = true && 
            ...
            ((this.statusResult==null && other.getStatusResult()==null) || 
             (this.statusResult!=null &&
              java.util.Arrays.equals(this.statusResult, other.getStatusResult()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getStatusResult() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getStatusResult());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getStatusResult(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NPOSQRspType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "NPOSQRspType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("MNPProtocol.xsd", "StatusResult"));
        elemField.setXmlType(new javax.xml.namespace.QName("MNPProtocol.xsd", "StatusResultType"));
        elemField.setNillable(false);
